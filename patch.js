...
content = replaceSafe(content, targetGroqItinerary, replacementGroqItinerary);
content = replaceSafe(content, targetCacheKey, replacementCacheKey);
content = replaceSafe(content, targetPrompt, replacementPrompt);

content = replaceSafe(content, targetChatbotDestruct, replacementChatbotDestruct);
content = replaceSafe(content, targetChatbotPrompt, replacementChatbotPrompt);

content = replaceSafe(content, targetPremiumGenerate, replacementPremiumGenerate);
content = replaceSafe(content, targetPremiumPrompt, replacementPremiumPrompt);
