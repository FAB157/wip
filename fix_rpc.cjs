...
const sql = `
-- Drop all possible signatures of get_geofence_pois
DROP FUNCTION IF EXISTS public.get_geofence_pois(DOUBLE PRECISION, DOUBLE PRECISION, UUID, DOUBLE PRECISION);
DROP FUNCTION IF EXISTS public.get_geofence_pois(DOUBLE PRECISION, DOUBLE PRECISION, UUID, INTEGER);

-- Drop all possible signatures of get_nearby_pois
DROP FUNCTION IF EXISTS public.get_nearby_pois(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION);
DROP FUNCTION IF EXISTS public.get_nearby_pois(DOUBLE PRECISION, DOUBLE PRECISION, INTEGER);

-- Recreate get_nearby_pois
